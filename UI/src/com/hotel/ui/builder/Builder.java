...
import com.hotel.ui.action.NullAction;
import com.hotel.ui.action.SaveData;
...
public class Builder {
	...
	private void guestMenu(Menu guest) {
		...
		guest.addItem(new MenuItem("Save data", rootMenu, new SaveData()));

	}

	private void roomMenu(Menu room) {
		...
		room.addItem(new MenuItem("Save data", rootMenu, new SaveData()));
	}

	private void optionMenu(Menu option) {
		...
		option.addItem(new MenuItem("Save data", rootMenu, new SaveData()));
	}
	...
	private void historyMenu( Menu history) {
		...
		history.addItem(new MenuItem("Save data", rootMenu, new SaveData()));
	}
	...
	private void rootMenuInit(final Menu room, final Menu guest, final Menu option,final  Menu history) {
	   ...
	   rootMenu.addItem(new MenuItem("Save data", rootMenu, new SaveData()));
